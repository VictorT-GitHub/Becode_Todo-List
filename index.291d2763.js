...
})({"iqWEK":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "08870567291d2763";
"use strict";
...
},{}],"6Rf0g":[function(require,module,exports) {
...
addTaskBtn.addEventListener('click', ()=>{
    ...
    if (taskInput.value) {
        ...
        _functions.pushTask(taskListArray, taskInput.value);
        // Create text + btn for the new task and display them in <taskListSection>
        _functions.displayTask(taskListArray, taskListSection, textIfEmptyList);
        // Clear input value after use
        _functions.clearValue(taskInput);
    }
});

},{"./functions":"h7eLW"}],"h7eLW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// ---------------------------------------------------------------EXPORT------------
parcelHelpers.export(exports, "clearValue", ()=>clearValue
);
// ---------------------------------------------------------------EXPORT------------
...
function displayTask(array, listSection, emptyListText) {
    let task = document.createElement('article');
    let taskText = document.createElement('p');
    taskText.innerHTML = array[array.length - 1];
    let taskBtn = document.createElement('button');
    taskBtn.innerHTML = "remove";
    taskBtn.addEventListener('click', ()=>removeTask(task, taskText, array, listSection, emptyListText)
    );
...
},{}]},["iqWEK","6Rf0g"], "6Rf0g", "parcelRequire5b66")

//# sourceMappingURL=index.291d2763.js.map
